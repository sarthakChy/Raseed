    ...
    return (
        <div className="max-w-md mx-auto">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 text-center">
                ...
                <h2 className="text-lg font-semibold mb-2">Chat Interface Coming Soon</h2>
                <p className="text-slate-500">This is where you'll be able to ask RASEED questions in any language.</p>
            </div>
        </div>
    );
}

export default AskRaseed;
...
//         "http://localhost:8000/api/receipts/analyze",
//         {
//           method: "POST",
...
//             className="flex flex-col items-center justify-center border-2 border-dashed border-slate-300 rounded-xl p-12 text-center cursor-pointer hover:bg-slate-100 transition"
//           >
